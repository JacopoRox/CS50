...
require 'states/background/BackgroundPlayState'
require 'states/background/BackgroundSelectionState'

require 'states/game/StartState'
require 'states/game/SelectionState'
require 'states/game/PlayState'
require 'states/game/GameOverState'
require 'states/game/PauseState'

require 'states/entities/hero/HeroAttackState'
require 'states/entities/hero/HeroRangedState'
require 'states/entities/hero/HeroDeathState'
require 'states/entities/hero/HeroFallingState'
require 'states/entities/hero/HeroIdleState'
require 'states/entities/hero/HeroJumpingState'
require 'states/entities/hero/HeroRunState'
require 'states/entities/hero/HeroTakeHitState'

require 'states/entities/EntityIdleState'
require 'states/entities/EntityAttackState'
require 'states/entities/EntityRangedState'
require 'states/entities/EntityRunState'
